...
public class ReservationFileRepositoryDouble implements ReservationRepository {
    ...
    public ReservationFileRepositoryDouble(String directory, HostFileRepository hostFileRepository, GuestFileRepository guestFileRepository){this.directory = directory; this.hostFileRepository = hostFileRepository; this.guestFileRepository = guestFileRepository;
    }
    String hostID;
    int guestID;
